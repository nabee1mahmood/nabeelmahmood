...
import './contact.css'
import mail_icon from "/Users/nabeelmahmood/nabeels-react-portfolio/src/assets/icons8-email-50 (2).png";
 import call_icon from "/Users/nabeelmahmood/nabeels-react-portfolio/src/assets/icons8-phone-number-50 (2).png";
 import linkedin_icon from "/Users/nabeelmahmood/nabeels-react-portfolio/src/assets/icons8-linkedin-50 (1).png";
 import github_icon from "/Users/nabeelmahmood/nabeels-react-portfolio/src/assets/icons8-github-50.png";
            ...
            <div className="contact-details">
                <div className="contact-detail">
                    <div className="icon-container">
                        <img src={mail_icon} alt="" className="contact-icon" /> 
                    </div>
                    <p className="contact-text email">nabeelmah1738@gmail.com</p>
                </div>
                <div className="contact-detail">
                    <div className="icon-container">
                       <img src={call_icon} alt="" className="contact-icon" /> 
                    </div>
